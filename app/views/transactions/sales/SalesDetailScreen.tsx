...
export default function SalesDetailScreen() {
    ...
    const [saleTransaction, setSaleTransaction] = useState<SalesTransaction>({
        transact_id,
        buyer_id: "",
    ...
    useEffect(() => {
        const data = saleDetails.data;
        if (data === undefined) return;
        setSaleTransaction({
            ...data.header
        })

        const buyer = buyers.find(s => s.buyer_id === data.header.buyer_id);
        if (buyer !== undefined) handleSelectBuyer(buyer)
    ...
    }, [saleDetails.data, inventory, buyers])
