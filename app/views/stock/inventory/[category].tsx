							...
							>
								...
								<View style={{
									...
									<View style={{
										...
										<Text style={styles.text_secondary}>B: {typeof item.buy_price === "number" ? item.buy_price.toFixed(2) : "N/A"}</Text>
										<Text style={styles.text_secondary}>S: {typeof item.sell_price === "number" ? item.sell_price.toFixed(2) : "N/A"}</Text>
									</View>
								</View>
							</View>
						</Pressable>
